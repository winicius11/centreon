...
.. note::
   By default, locked host templates are hidden. Tick the "Display locked" box to list all templates.
...
.. note::
   By default, locked service templates are hidden. Tick the "Display locked" box to list all templates.
