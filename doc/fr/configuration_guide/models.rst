...
.. note::
   Par défaut, les modèles d'hôte vérouillés sont masqués. Cocher la case "Afficher vérouillé" pour les afficher tous.
...
.. note::
   Par défaut, les modèles de service vérouillés sont masqués. Cocher la case "Afficher vérouillé" pour les afficher tous.
